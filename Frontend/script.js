...
async function finTache(id) {
  ...
  // 🛑 Vérification si la tâche est en pause
  if (t.status === "PAUSE") {
    alert("⚠️ Vous devez reprendre la tâche avant de la terminer !");
    return;
  }

  // ✅ Sinon on peut terminer normalement
